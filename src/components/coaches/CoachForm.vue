<template>
    <form @submit.prevent="submitForm">
        ...
        <div class="form-control" :class="{invalid: !description.isValid}">
            ...
            <p v-if="!description.isValid">Please write your description</p>
        </div>
        <div class="form-control" :class="{invalid: !rate.isValid}">
            <label for="rate">Rate</label>
            <input type="text" id="rate" v-model.number="rate.val" @blur="clearValidty('rate')" />
        ...
        <div class="form-control" :class="{invalid: !areas.isValid}">
            ...
            <div>
                ...
                <label for="careed">Career Advisory</label>
            </div>
            <p v-if="!areas.isValid">Provide any area of expertise</p>
        </div>
        <p v-if="!formIsValid">Please fix some form error</p>
